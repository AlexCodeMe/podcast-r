    ...
    <>
      <div className="mt-[30px] flex w-full max-w-[520px] flex-col justify-between gap-2 rounded-lg border border-black-6 bg-black-1 px-2.5 py-2 md:flex-row md:gap-0">
        ...
        <Button type="button"
          ...
          className={cn('', !isAiThumbnail && 'bg-black-6' )}
        >
          Upload custom image
        </Button>
      </div>
      {isAiThumbnail ? (
        <div className="flex flex-col gap-5">
          <div className="mt-5 flex flex-col gap-2.5">
            ...
            <Textarea 
              className="text-[16px] leading-normal placeholder:leading-normal placeholder:text-[16px] bg-black-1 rounded-[6px] placeholder:text-gray-1 border-none text-gray-1 font-light focus-visible:ring-offset-orange-1"
        ...
        <div className="image_div" onClick={() => imageRef?.current?.click()}>
          ...
          <div className="flex flex-col items-center gap-1">
           <h2 className="text-[12px] leading-normal font-bold text-orange-1">
            ...
            <p className="text-[12px] leading-normal font-normal text-gray-1">SVG, PNG, JPG, or GIF (max. 1080x1080px)</p> 
          </div>
        </div>
      )}
      {image && (
